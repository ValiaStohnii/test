...
import { raitingStars, resume } from './redux/slices/resumeSlice';
...
const toggleCongratulationsModal =()=>{
  ...
  // const resume =useSelector(state.resume.values, )
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      console.log(values['simple-controlled']);
      dispatch(resume(values.text));
      dispatch(raitingStars(values['simple-controlled']));
    },
  });
...
//           <Text>Ти молодчина, 
// але потрібно швидше! 
// Наступного разу тобі все вдасться</Text>
//           <Buttons>
//             <NewTraining type='submit'>Новє тренування</NewTraining>
//             <Back onClick={toggleWellDoneModal} type='button'>Назад</Back>
//           </Buttons>
//         </WellDoneContent>
//     )
// };
